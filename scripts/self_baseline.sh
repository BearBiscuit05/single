...
# MODELNAME="SAGE"
ExecuteDGLPath="/home/bear/workspace/single-gnn/src/train/dgl/dgl_train.py"
ExecutePYGPath="/home/bear/workspace/single-gnn/src/train/pyg/pyg_train.py"
...
#                 --maxloop ${MAXLOOP} --dataset com_fr" 
#         echo "--------------------------------------------------------------" 
